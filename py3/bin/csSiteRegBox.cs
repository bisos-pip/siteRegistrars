...
(setq  b:py:cs:csuList
  (list
   "bisos.b.cs.ro"
   "blee.csPlayer.bleep"
   "bisos.siteRegistrars.csSiteRegBox"
 ))
#+END_SRC
#+RESULTS:
| bisos.b.cs.ro | blee.csPlayer.bleep | bisos.siteRegistrars.csSiteRegBox |
#+end_org """
...
from bisos.siteRegistrars import csSiteRegBox


csuList = [ 'bisos.b.cs.ro', 'blee.csPlayer.bleep', 'bisos.siteRegistrars.csSiteRegBox', ]
...
####+BEGINNOT: b:py3:cs:main/exposedSymbols :classes ("fp_csu.ExampleFilePars")
""" #+begin_org
...
####+END:
        ...
        csSiteRegBox.examples_csu(sectionTitle="default")
